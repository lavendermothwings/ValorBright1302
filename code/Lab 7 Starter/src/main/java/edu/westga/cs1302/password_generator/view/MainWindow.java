...
//    	
//    	try {
//    		//this.generator.setMinimumLength(minimumLength);//need to replace
//    		//view.checkMin();
...
//    	}
//    	
//    	view.getGenInfo(minimumLength, this.mustIncludeDigits.isSelected(), this.mustIncludeLowerCaseLetters.isSelected(), this.mustIncludeUpperCaseLetters.isSelected());
//    	
//    	String password = view.generateThis();
...
//    	}
    ...
    public void bindComponentsToViewModel() {
    	this.minimumLength.textProperty().bindBidirectional(this.view.minimumLengthProperty(), new NumberStringConverter());
    	//this.mustIncludeDigits.selectedProperty().bind(this.view.getDigitProperty());
    	this.view.getDigitProperty().bind(this.mustIncludeDigits.selectedProperty());
